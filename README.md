...
- Press **/** to search current files and folders; choose a result to fly there. Close views have shaded building facades, warm windows, paved streets, sidewalks, and streetlights. A clickable minimap appears while exploring without a selection or inspector.
